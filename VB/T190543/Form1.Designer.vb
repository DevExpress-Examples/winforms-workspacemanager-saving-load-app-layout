...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(T190543.Form1))
            ...
            Me.saveItem.Glyph = CType((resources.GetObject("saveItem.Glyph")), System.Drawing.Image)
            Me.saveItem.Id = 1
            Me.saveItem.LargeGlyph = CType((resources.GetObject("saveItem.LargeGlyph")), System.Drawing.Image)
            Me.saveItem.Name = "saveItem"
            AddHandler Me.saveItem.ItemClick, New DevExpress.XtraBars.ItemClickEventHandler(AddressOf Me.saveItem_ItemClick)
            ' 
            ' loadItem
            ' 
            Me.loadItem.Caption = "Load Workspace"
            Me.loadItem.Glyph = CType((resources.GetObject("loadItem.Glyph")), System.Drawing.Image)
            Me.loadItem.Id = 2
            Me.loadItem.LargeGlyph = CType((resources.GetObject("loadItem.LargeGlyph")), System.Drawing.Image)
            Me.loadItem.Name = "loadItem"
            AddHandler Me.loadItem.ItemClick, New DevExpress.XtraBars.ItemClickEventHandler(AddressOf Me.loadItem_ItemClick)
            ' 
            ' captureItem
            ' 
            Me.captureItem.Caption = "Capture Workspace"
            Me.captureItem.Glyph = CType((resources.GetObject("captureItem.Glyph")), System.Drawing.Image)
            Me.captureItem.Id = 3
            Me.captureItem.LargeGlyph = CType((resources.GetObject("captureItem.LargeGlyph")), System.Drawing.Image)
            Me.captureItem.Name = "captureItem"
            AddHandler Me.captureItem.ItemClick, New DevExpress.XtraBars.ItemClickEventHandler(AddressOf Me.captureItem_ItemClick)
            ' 
            ' applyItem
            ' 
            Me.applyItem.Caption = "Apply Workspace"
            Me.applyItem.Glyph = CType((resources.GetObject("applyItem.Glyph")), System.Drawing.Image)
            Me.applyItem.Id = 4
            Me.applyItem.LargeGlyph = CType((resources.GetObject("applyItem.LargeGlyph")), System.Drawing.Image)
            Me.applyItem.Name = "applyItem"
            AddHandler Me.applyItem.ItemClick, New DevExpress.XtraBars.ItemClickEventHandler(AddressOf Me.applyItem_ItemClick)
            ' 
            ' workspaceNameItem
            ' 
...
#End Region
        ...
        Private saveItem As DevExpress.XtraBars.BarButtonItem

        Private loadItem As DevExpress.XtraBars.BarButtonItem

        Private captureItem As DevExpress.XtraBars.BarButtonItem

        Private applyItem As DevExpress.XtraBars.BarButtonItem
